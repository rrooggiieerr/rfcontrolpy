...
class TestContact4(unittest.TestCase):
    def test_decode_open(self) -> None:
        # First signal (contact opened). Expect id 609760, contact True, lowBattery False
    ...
    def test_decode_close(self) -> None:
        # Second signal (contact closed). Expect same id, contact False, lowBattery False
        decoded = contact4.decode("0110101010100101011012")
