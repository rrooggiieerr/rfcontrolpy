...
class TestControler(unittest.TestCase):
    ...
    def test_sort_compressed_pulses(self) -> None:
        result = controller.sort_compressed_pulses([480, 1988, 1020, 3976], "01020102020102020202020202020202010202010102010201010101020102020101020103")
        self.assertEqual(
            ([480, 1020, 1988, 3976], "02010201010201010101010101010101020101020201020102020202010201010202010203"),
            result
        )
